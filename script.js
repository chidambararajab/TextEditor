...
function updateText(){
  ...
  function makeUnderline(elem){
      //CODE GOES HERE
      elem.classList.toggle('active');
      let containsValue = elem.classList.contains('active');
      if (containsValue) {
  ...
  function alignText(elem, alignType){
    ...
    let buttonAlign = document.getElementsByClassName('align');
    for (let i = 0; i < buttonAlign.length; i++) {
        buttonAlign[i].classList.remove('active');
    }
